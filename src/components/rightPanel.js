            ...
            <Table>
                ...
                <TableBody id='shoppingCart'>
                        { props.cart !== null 
                            ? props.cart.map((item, i) => (
                                <TableRow id={"itemRow" + i} key={"itemRow" + i}>
                                    ...
                                    <TableCell align='center'>$ {item.totalPrice * item.quantity}</TableCell>
                                </TableRow>
                            ))
                            : ""}
                    <TableRow>
                    ...
                    <TableRow id='taxRow'>
                        ...
                        <TableCell></TableCell>
                        <TableCell align='center'>$ {props.subTotal ==0 ? 0 : (props.subTotal * 0.05)}</TableCell>
                    </TableRow>
                    <TableRow id="totalPriceRow">
                        ...
                        <TableCell align='center'>
                            $ {props.subTotal > 50 || props.subTotal === 0 ? (props.subTotal + (props.subTotal * 0.05)) :
                                (props.subTotal + (props.subTotal * 0.05) + 3)}
                        </TableCell>
                    </TableRow>
                </TableBody>
            </Table>
